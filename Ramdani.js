...
const {
   ...
   const exif = new Exif();
   //ೋ❀❀ೋ═══[SUBSCRIBE RAMDANI OFFICIAL]═══ೋ❀❀ೋ//
   const { allMenu, downloadMenu, infoMenu, groupMenu, funMenu, wibuMenu, ownerMenu, stickerMenu, otherMenu, rulesBot, islamMenu, sertiMenu, ceritaMenu, makerMenu,dewasaMenu, toolsMenu} = require('./message/help.js')
   ...
   module.exports = Ramdani = async (Ramdani, mek) => {
          try {
           ...
           const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
               let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
          ...
          console.error(err)
           ...
           const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙`,"description": "ALIF ANANTA", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "ALIF ANANTA","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
   ...
   *Sssttt! Orangnya lagi AFK, jangan diganggu!*
   ...
   └⬣`
                  ...
                  buttonsMessage = {
                  contentText: `${allmenu}`,
                  footerText: 'ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴅᴏɴᴀsɪ ʏᴀ ᴛᴏᴛ, ᴄᴀᴘᴇ ᴄᴏᴅɪɴɢ ᴛᴇʀᴜs:ᴠ\nᴅᴀɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ɢʀᴜᴘ ɢᴡ ʏᴀ ᴛᴏᴛ\nɢʀᴜᴘ Alif Ananta : https://chat.whatsapp.com/HbEeO3RlUosIYNX91xFhY2© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙', imageMessage: imageMsg,
                  buttons: buttons,
                  headerType: 4
   }
   ...
   🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
           ...
           case 'command':
                  list = []
                  listmenu = [`storemenu`,`jokimenu`,`infomenu`,`groupmenu`,`makermenu`,`stickermenu`,`warmenu`,`hewanmenu`,`beritamenu`,`wibumenu`,`randommenu`,`ownermenu`,`spammenu`,`searchmenu`,`memesmenu`]
                  listmenuu = [`Store Menu`,`Joki Menu`,`Info Menu`,`Group Menu`,`Maker Menu`,`Sticker Menu`,`War Menu`,`Hewan Menu`,`Berita Menu`,`Wibu Menu`,`Random Menu`,`Owner Menu`,`Spam Menu`,`Search Menu`,`Meme Menu`]
                  nombor = 1
                  startnum = 0
   ...
   *Data Berhasil Didapatkan!*
   ...
   Ramdani.sendMessage(_.jid, 
                        ...
                        "footerText": '© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙',
                        "buttons": [
   ...
   *━━━━━━━━━━━━━━━━━━━━*`)
   ...
   //----------------<store menu>----------------
                  ...
                  case 'sm':
                  list = []
                  listgame = [`sewabot`,`buttonml`,`buttonff`,`buttonpubg`,`buttonssm`,`buttonpb`,`buttonvalo`]
                  listgamee= [`Sewa Bot`,`Mobile Legends`,`Free Fire`,`Pubg`,`Sausage Man`,`Point Blank`,`Valorant`]
                  nombor = 1
                  startnum = 0
             ...
             ➖➖➖➖➖➖➖➖➖➖➖`
                           ...
                           Ramdani.relayWAMessage(prep)
                             ...
                             case 'joki menu':
                                   ...
                                   case 'sm':
                                   list = []
                                   listgame = [`buttonjokiml`,`buttonjokipb`,`buttonvalo`]
                                   listgamee= [`Mobile Legends`,`Point Blank`,`Valorant`]
                                   nombor = 1
                                   startnum = 0
                                   for (let x of listgame) {
                                   const yy = {title: 'Menu ' + nombor++,
                                   ...
                                   listmsg(from, `${ucapanWaktu}`,  `*Hallo Kak* ${pushname}\nSilahkan Pilih Game yang ingin dijoki Disini`, list)
                                   break     
...
GB EXP Premium
1 Juta EXP     Rp.20.000
3 Juta EXP     Rp.50.000
5 Juta EXP     Rp.80.000

GB EXP VIP
5 Juta EXP     Rp.70.000
10 Juta EXP     Rp.100.000
20 Juta EXP     Rp.200.000

GB EXP Clan
10 Juta EXP     Rp.170.000
20 Juta EXP     Rp.300.000
30 Juta EXP     Rp.450.000

GB KD
10.000 HS/Badan      Rp.30.000
20.000 HS/Badan      Rp.50.000
50.000 HS/Badan      Rp.80.000
100.000 HS/Badan     Rp.140.000
200.000 HS/Badan     Rp.280.000
300.000 HS/Badan     Rp.420.000
500.000 HS/Badan     Rp.650.000
1.000.000 HS/Badan   Rp.1.000.000
...
➖➖➖➖➖➖➖➖➖➖➖`
   ...
   //payment                
         case 'dana':
                ...
                break
              case 'gopay':
                reply(`*Goopay :* 085890617231`)
                break  
            case 'pulsa':
                reply(`*Pulsa :* 085890617231`)
                break              
         case 'infoig':
